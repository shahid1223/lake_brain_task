    ...
    return (
        <main className="flex min-h-screen flex-col items-center justify-between p-24">
            <div className='space-y-4'>
                ...
                <div className='flex justify-center items-center'>
                    <Link href='/' className='text-[#20DF7F] w-full text-center text-[14px] font-normal leading-normal '>Already have account? <span className='underline'>Sign up</span></Link>
                </div>
